...
public class UpdateSalesOrderRequest {
    ...
    @Valid
    @NotNull
    private List<UpdateSalesOrderLineRequest> lines;
    ...
    public List<UpdateSalesOrderLineRequest> getLines() {
        return lines;
    }

    public void setLines(List<UpdateSalesOrderLineRequest> lines) {
        this.lines = lines;
    }
